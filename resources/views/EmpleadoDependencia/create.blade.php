...
@section('title', 'Asignar Empleado a Dependencia')
...
<div class="d-flex justify-content-center align-items-center" style="min-height:100vh; background:#f7f7f7;">
    <div class="p-4 shadow" style="width:420px; background:white; border-radius:8px;">
        ...
        <div class="text-center mb-3">
            <h5 class="fw-bold text-dark">ASIGNAR EMPLEADO A DEPENDENCIA</h5>
        </div>
        ...
        {{-- Formulario --}}
        <form action="{{ route('EmpleadoD.store') }}" method="POST">
            @csrf
            ...
            <div class="text-center mt-3">
                <a href="{{route('EmpleadoD.index')}}" class="btn btn-link text-decoration-none text-danger fw-semibold">
                    ← Volver
                </a>
            </div>
        </form>
